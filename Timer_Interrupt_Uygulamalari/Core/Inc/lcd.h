...
void Lcd_Cmd(uint8_t cmd); // Komut gönderir (Temizle, kaydır vb.)
void Lcd_Char(char data); // Tek karakter yazar
void Lcd_String(char *str); // Kelime/Cümle yazar
void Lcd_Set_Cursor(uint8_t row, uint8_t col); // İmleci konumlandırır (Satır
